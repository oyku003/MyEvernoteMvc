...
namespace MyEverNoteMvc.Entities.ValueObjects
{
    public class RegisterViewModel
    {
        ...
        [DisplayName("E-Posta"), Required(ErrorMessage = "{0} alanı boş geçilemez."), DataType(DataType.Password), StringLength(70, ErrorMessage = "{0} max {1} karakter olmalı"),EmailAddress(ErrorMessage ="{0} alanı için geçerli bir e posta giriniz.")]
